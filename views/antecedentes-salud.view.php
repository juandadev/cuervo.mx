<form action="#" method="post" id="quizForm02" class="quizForm02">
    ...
    <div id="op_02" class="optional hiddenOpt">
        ...
        <input type="text" id="q_02_01" class="input" placeholder="Especifique">
    </div>
    ...
    <div class="radioContainer">
        ...
        <div class="radioOptions">
            <label for="r_03_01" class="input lblContainer" onclick="toogleOptionOn(this, 03)">
                Sí
                <input type="radio" name="q_03" id="r_03_01" value="1">
                <span class="radio r02"></span>
            </label>

            <label for="r_03_02" class="input lblContainer" onclick="toogleOptionOff(this, 03)">
                No
                <input type="radio" name="q_03" id="r_03_02" value="0" checked>
                <span class="radio r02"></span>
            </label>
        </div>
    </div>
    ...
    <div id="op_03" class="optional hiddenOpt">
        ...
        <input type="text" id="q_03_01" class="input" placeholder="Especifique">
    </div>
    ...
    <div class="radioContainer">
        ...
        <div class="radioOptions">
            <label for="r_04_01" class="input lblContainer" onclick="toogleOptionOn(this, 04)">
                Sí
                <input type="radio" name="q_04" id="r_04_01" value="1">
                <span class="radio r02"></span>
            </label>

            <label for="r_04_02" class="input lblContainer" onclick="toogleOptionOff(this, 04)">
                No
                <input type="radio" name="q_04" id="r_04_02" value="0" checked>
                <span class="radio r02"></span>
            </label>
        </div>
    </div>
    ...
    <div id="op_04" class="optional hiddenOpt">
        ...
        <input type="text" id="q_04_01" class="input" placeholder="Especifique">

        <label for="q_04_02" class="label">Dosis:</label>
        <input type="text" id="q_04_02" class="input" placeholder="Cantidad">
    </div>
    ...
    <div class="radioContainer">
        ...
        <div class="radioOptions">
            <label for="r_05_01" class="input lblContainer" onclick="toogleOptionOn(this, 05)">
                Sí
                <input type="radio" name="q_05" id="r_05_01" value="1">
                <span class="radio r02"></span>
            </label>

            <label for="r_05_02" class="input lblContainer" onclick="toogleOptionOff(this, 05)">
                No
                <input type="radio" name="q_05" id="r_05_02" value="0" checked>
                <span class="radio r02"></span>
            </label>
        </div>
    </div>
    ...
    <div id="op_05" class="optional hiddenOpt">
        ...
        <input type="text" id="q_05_01" class="input" placeholder="Especifique">
    </div>
